...
<p class="small">Hybrid CNN-LSTM-Transformer FX forecasting with FinBERT news sentiment and
integrated XGBoost + GARCH experts · multi-currency (gold XAU/USD, silver XAG/USD, euro
EUR/USD — separate per-pair pipelines) · generated by <code>generate_final_report.py</code></p>
<p class="small"><b>Reading guide.</b> Sections 1–5 document the data and architecture on the
primary instrument (gold); Section 6 benchmarks against ARIMA/GARCH, with <b>Section 6b</b>
giving the head-to-head <b>per-currency</b> results; Sections 7–8 cover comparison graphs and
the full roadmap record (adaptive expert, dual-expert fusion, Trend-Gated Committee,
cross-pair transfer); Section 9 concludes.</p>
""")
