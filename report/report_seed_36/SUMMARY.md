...
|---|---|---|---|---|---|
| Hybrid_CNN_LSTM_Transformer | 0.00156 | 0.00228 | 313.7 | 0.4963 | 0.4954 |
...
- Hybrid_CNN_LSTM_Transformer's directional accuracy (0.4963) is close to the 0.5 random-guess baseline — treat any directional edge from this run as inconclusive rather than a confirmed skill.
