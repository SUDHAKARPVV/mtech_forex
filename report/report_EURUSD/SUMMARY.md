...
|---|---|---|---|---|---|
| Hybrid_CNN_LSTM_Transformer | 0.00167 | 0.00249 | 372.9 | 0.4994 | 0.5010 |
...
- Hybrid_CNN_LSTM_Transformer's directional accuracy (0.4994) is close to the 0.5 random-guess baseline — treat any directional edge from this run as inconclusive rather than a confirmed skill.
